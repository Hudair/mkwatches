...
(function($, document) {
    ...
    var jckqv = {
        ...
        on_ready: function() {
            ...
            if( jckqv.is_true( jckqv_vars.settings.popup_content_ajaxcart ) ) { jckqv.setup_add_to_cart(); }
            if( jckqv.is_true( jckqv_vars.settings.trigger_styling_autohide ) ) { jckqv.setup_modal_on_hover(); }
        ...
        get_products: function() {
            ...
            $('body').trigger('jckqv_getProducts');
        ...
        watch_variations: function() {
                ...
                if( variation.sku ) {
                    ...
                    jckqv.modal.sku.html( 'n/a' );
 	                ...
 	                if (typeof $.fn.tawcvs_variation_swatches_form !== 'undefined') {
	                    jckqv.modal.variations_form.tawcvs_variation_swatches_form();
	                }             
            ...
            if (typeof wc_add_to_cart_variation_params !== 'undefined') {
                ...
                jckqv.modal.variations_form.each(function () {
        ...
        setup_add_to_cart: function() {
            ...
            $("body").on('submit', "#jckqv form.cart", function(e){
                ...
                jckqv.add_to_cart(query, $the_buton, function(response){
         ...
         */
        add_to_cart: function( query, $the_buton, callback ) {

            var data = $.getQueryParameters(query);

            data.action = 'jckqv_add_to_cart';
            data.nonce = jckqv_vars.nonce;
            data.product_id = typeof data['add-to-cart'] === "undefined" ? $the_buton.val() : data['add-to-cart'];

            delete data['add-to-cart'];

            $( 'body' ).trigger( 'adding_to_cart', [ $the_buton ] );

            $.get(jckqv_vars.ajaxurl, data, function(response) {

                if(response.fragments !== undefined){

                    jckqv.update_cart_widget( response.fragments, response.cart_hash );
         ...
         * @param cart_hash
         */
        update_cart_widget: function( fragments, cart_hash ) {
        ...
        reset_modal: function() {
            ...
            if( jckqv.vars.add_to_cart_params ) { wc_add_to_cart_params = jckqv.vars.add_to_cart_params; }
            if( jckqv.vars.add_to_cart_variation_params ) { wc_add_to_cart_variation_params = jckqv.vars.add_to_cart_variation_params; }
